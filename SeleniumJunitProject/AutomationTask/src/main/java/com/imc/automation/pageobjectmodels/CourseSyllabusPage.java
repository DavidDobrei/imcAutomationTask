...
public class CourseSyllabusPage extends BasePage{
    ...
    public boolean isCourseImageDisplayedSyllabus() {
        ...
        return courseImageElementSyllabus.isDisplayed();
    }
    ...
    public boolean isCourseActionsDisplayedSyllabus() {
        ...
        return courseActionsElement.isDisplayed();
    }
    // media1 status
    public String getMedia1Status () {
        ...
        return media1StatusIconElement.getAttribute("aria-label");
    }
    // media2 status
    public String getMedia2Status () {
        ...
        return media2StatusIconElement.getAttribute("aria-label");
    }
    ...
    public String getCourseProgressPercentage () {
        ...
        return courseProgressPercentageElement.getText();
    }
    // open MoocBild1
    ...
    public String getCourseStatus (){
        ...
        return driver.findElement(courseStatus).getText();
    }
    public void signOut() {
