...
// Locators
    ...
    public boolean isCourseTypeDisplayed () {
        ...
        return waitForElement(courseType).isDisplayed();
    }
    ...
    public boolean isEnrollButtonDisplayed () {
        ...
        return waitForElement(enrollButton).isDisplayed();
    }
    // enroll user
    public CourseSyllabusPage enrolUser() {
        ...
        waitForElementToBeClickable(enrollButton).click();
        waitForElementToBeClickable(enrollButtonModal).click();
